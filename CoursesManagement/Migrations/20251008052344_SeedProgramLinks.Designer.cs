...
namespace CoursesManagement.Migrations
{
    ...
    [Migration("20251008052344_SeedProgramLinks")]
    partial class SeedProgramLinks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoursesManagement.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 8, 5, 23, 43, 508, DateTimeKind.Utc).AddTicks(6965)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 8, 5, 23, 43, 508, DateTimeKind.Utc).AddTicks(7908)
                        });
                });
            ...
            modelBuilder.Entity("CoursesManagement.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 8, 5, 23, 43, 508, DateTimeKind.Utc).AddTicks(8600),
                            Price = 0m
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 8, 5, 23, 43, 508, DateTimeKind.Utc).AddTicks(9992),
                            Price = 0m
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 8, 5, 23, 43, 508, DateTimeKind.Utc).AddTicks(9997),
                            Price = 0m
                        });
                });
            ...
            modelBuilder.Entity("CoursesManagement.Models.Enrollment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CourseId = new Guid("55555555-5555-5555-5555-555555555555"),
                            EnrolledAt = new DateTime(2025, 9, 18, 5, 23, 43, 509, DateTimeKind.Utc).AddTicks(2174),
                        ...
                        new
                        {
                            ...
                            CourseId = new Guid("66666666-6666-6666-6666-666666666666"),
                            EnrolledAt = new DateTime(2025, 8, 24, 5, 23, 43, 509, DateTimeKind.Utc).AddTicks(3433),
                            Grade = 91.5m,
                            ProgramId = new Guid("11111111-1111-1111-1111-111111111111"),
                            Status = "Completed",
                        ...
                        new
                        {
                            ...
                            CourseId = new Guid("77777777-7777-7777-7777-777777777777"),
                            EnrolledAt = new DateTime(2025, 9, 28, 5, 23, 43, 509, DateTimeKind.Utc).AddTicks(3809),
                        ...
                        new
                        {
                            ...
                            CourseId = new Guid("66666666-6666-6666-6666-666666666666"),
                            EnrolledAt = new DateTime(2025, 10, 3, 5, 23, 43, 509, DateTimeKind.Utc).AddTicks(3814),
                            ProgramId = new Guid("11111111-1111-1111-1111-111111111111"),
                            Status = "Dropped",
            ...
            modelBuilder.Entity("CoursesManagement.Models.Programs", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ProgramId = new Guid("11111111-1111-1111-1111-111111111111"),
                            CreatedAt = new DateTime(2025, 10, 8, 5, 23, 43, 508, DateTimeKind.Utc).AddTicks(4793),
                        ...
                        {
                            ProgramId = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 10, 8, 5, 23, 43, 508, DateTimeKind.Utc).AddTicks(6238),
            ...
            modelBuilder.Entity("ProgramCategories", b =>
                {
                    ...
                    b.HasKey("ProgramsProgramId", "CategoriesCategoryId");
                    ...
                    b.HasData(
                        new
                        {
                            ProgramsProgramId = new Guid("11111111-1111-1111-1111-111111111111"),
                            CategoriesCategoryId = new Guid("33333333-3333-3333-3333-333333333333")
                        },
                        new
                        {
                            ProgramsProgramId = new Guid("22222222-2222-2222-2222-222222222222"),
                            CategoriesCategoryId = new Guid("44444444-4444-4444-4444-444444444444")
                        });
                });

            modelBuilder.Entity("ProgramCourses", b =>
                {
                    b.Property<Guid>("ProgramsProgramId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ProgramsProgramId", "CoursesCourseId");
                    ...
                    b.HasData(
                        ...
                        {
                            ProgramsProgramId = new Guid("11111111-1111-1111-1111-111111111111"),
                            CoursesCourseId = new Guid("55555555-5555-5555-5555-555555555555")
                        },
                        new
                        {
                            ProgramsProgramId = new Guid("11111111-1111-1111-1111-111111111111"),
                            CoursesCourseId = new Guid("66666666-6666-6666-6666-666666666666")
                        },
                        new
                        {
                            ProgramsProgramId = new Guid("22222222-2222-2222-2222-222222222222"),
                            CoursesCourseId = new Guid("77777777-7777-7777-7777-777777777777")
                        });
                });
