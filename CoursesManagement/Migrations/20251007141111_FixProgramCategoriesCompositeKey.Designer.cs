...
namespace CoursesManagement.Migrations
{
    ...
    [Migration("20251007141111_FixProgramCategoriesCompositeKey")]
    partial class FixProgramCategoriesCompositeKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoursesManagement.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 7, 14, 11, 9, 996, DateTimeKind.Utc).AddTicks(7820)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 7, 14, 11, 9, 996, DateTimeKind.Utc).AddTicks(8766)
                        });
                });
            ...
            modelBuilder.Entity("CoursesManagement.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 7, 14, 11, 9, 996, DateTimeKind.Utc).AddTicks(9462),
                            Price = 0m
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 7, 14, 11, 9, 997, DateTimeKind.Utc).AddTicks(964),
                            Price = 0m
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 7, 14, 11, 9, 997, DateTimeKind.Utc).AddTicks(969),
                            Price = 0m
                        });
                });
            ...
            modelBuilder.Entity("CoursesManagement.Models.Enrollment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CourseId = new Guid("55555555-5555-5555-5555-555555555555"),
                            EnrolledAt = new DateTime(2025, 9, 17, 14, 11, 9, 997, DateTimeKind.Utc).AddTicks(3218),
                        ...
                        new
                        {
                            ...
                            CourseId = new Guid("66666666-6666-6666-6666-666666666666"),
                            EnrolledAt = new DateTime(2025, 8, 23, 14, 11, 9, 997, DateTimeKind.Utc).AddTicks(4528),
                            Grade = 91.5m,
                            ProgramId = new Guid("11111111-1111-1111-1111-111111111111"),
                            Status = "Completed",
                        ...
                        new
                        {
                            ...
                            CourseId = new Guid("77777777-7777-7777-7777-777777777777"),
                            EnrolledAt = new DateTime(2025, 9, 27, 14, 11, 9, 997, DateTimeKind.Utc).AddTicks(4876),
                        ...
                        new
                        {
                            ...
                            CourseId = new Guid("66666666-6666-6666-6666-666666666666"),
                            EnrolledAt = new DateTime(2025, 10, 2, 14, 11, 9, 997, DateTimeKind.Utc).AddTicks(4881),
                            ProgramId = new Guid("11111111-1111-1111-1111-111111111111"),
                            Status = "Dropped",
            ...
            modelBuilder.Entity("CoursesManagement.Models.Programs", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ProgramId = new Guid("11111111-1111-1111-1111-111111111111"),
                            CreatedAt = new DateTime(2025, 10, 7, 14, 11, 9, 996, DateTimeKind.Utc).AddTicks(5648),
                        ...
                        {
                            ProgramId = new Guid("22222222-2222-2222-2222-222222222222"),
                            CreatedAt = new DateTime(2025, 10, 7, 14, 11, 9, 996, DateTimeKind.Utc).AddTicks(7089),
